    ...
    <Box {...sectionWrapper} id="faq_section">
      <Container>
        <Box {...secTitleWrapper}>
          ...
          <Heading {...secHeading} content="Quer nos perguntar algo?" />
        </Box>
        <Box {...row}>
          <Box {...col}>
            <FaqWrapper>
            ...
            <Box {...buttonWrapper}>
              ...
              <Button
                {...button}
                title="ENTRE EM CONTATO ATRAVÉS DO CHAT"
                onClick={e => {
                  const chat = document.getElementsByClassName('hoverl_6R');
                  eventFire(chat[0], 'click');
                }}
              />
              {/* </a> */}
            </Box>
